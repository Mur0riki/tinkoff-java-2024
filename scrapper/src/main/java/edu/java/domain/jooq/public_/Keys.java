...
public class Keys {
    ...
    public static final UniqueKey<LinkChatRecord> LINK_CHAT_CHAT_ID_KEY = Internal.createUniqueKey(LinkChat.LINK_CHAT, DSL.name("link_chat_chat_id_key"), new TableField[] { LinkChat.LINK_CHAT.CHAT_ID }, true);
    public static final UniqueKey<LinkChatRecord> LINK_CHAT_LINK_ID_KEY = Internal.createUniqueKey(LinkChat.LINK_CHAT, DSL.name("link_chat_link_id_key"), new TableField[] { LinkChat.LINK_CHAT.LINK_ID }, true);
    public static final UniqueKey<LinkChatRecord> LINK_CHAT_PKEY = Internal.createUniqueKey(LinkChat.LINK_CHAT, DSL.name("link_chat_pkey"), new TableField[] { LinkChat.LINK_CHAT.ID }, true);
