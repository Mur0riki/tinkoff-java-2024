...
public class LinkChat extends TableImpl<LinkChatRecord> {
    ...
    /**
     * The column <code>public.link_chat.id</code>.
     */
    public final TableField<LinkChatRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<LinkChatRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
    ...
    @Override
    @NotNull
    public Identity<LinkChatRecord, Long> getIdentity() {
        return (Identity<LinkChatRecord, Long>) super.getIdentity();
    }
    ...
    public List<UniqueKey<LinkChatRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.LINK_CHAT_CHAT_ID_KEY, Keys.LINK_CHAT_LINK_ID_KEY);
    }
