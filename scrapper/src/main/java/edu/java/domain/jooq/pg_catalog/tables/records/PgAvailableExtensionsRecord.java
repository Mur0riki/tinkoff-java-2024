...
public class PgAvailableExtensionsRecord extends TableRecordImpl<PgAvailableExtensionsRecord> implements Record4<String, String, String, String> {
     ...
     */
    public void setInstalledVersion(@Nullable String value) {
        set(2, value);
    }
    ...
    @Override
    @NotNull
    public PgAvailableExtensionsRecord value4(@Nullable String value) {
        setComment(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public PgAvailableExtensionsRecord values(@Nullable String value1, @Nullable String value2, @Nullable String value3, @Nullable String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public PgAvailableExtensionsRecord(@Nullable String name, @Nullable String defaultVersion, @Nullable String installedVersion, @Nullable String comment) {
        super(PgAvailableExtensions.PG_AVAILABLE_EXTENSIONS);
    ...
    public PgAvailableExtensionsRecord(edu.java.domain.jooq.pg_catalog.tables.pojos.PgAvailableExtensions value) {
        ...
        if (value != null) {
            ...
            setInstalledVersion(value.getInstalledVersion());
