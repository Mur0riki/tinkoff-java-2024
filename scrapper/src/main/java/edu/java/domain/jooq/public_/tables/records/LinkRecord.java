...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, String, LocalDateTime, LocalDateTime> {
    ...
    @Override
    @NotNull
    public LinkRecord values(@Nullable Long value1, @NotNull String value2, @NotNull LocalDateTime value3, @Nullable LocalDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinkRecord(@Nullable Long id, @NotNull String url, @NotNull LocalDateTime createdAt, @Nullable LocalDateTime lastCheckedAt) {
        super(Link.LINK);
     ...
     * Create a detached, initialised LinkRecord
     */
    public LinkRecord(edu.java.domain.jooq.public_.tables.pojos.Link value) {
        super(Link.LINK);
