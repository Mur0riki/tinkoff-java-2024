...
public class PgCatalog extends SchemaImpl {
    ...
    public static Result<PgConfigRecord> PG_CONFIG(
        ...
        return configuration.dsl().selectFrom(edu.java.domain.jooq.pg_catalog.tables.PgConfig.PG_CONFIG.call(
        )).fetch();
    }
    ...
    public static PgConfig PG_CONFIG() {
        return edu.java.domain.jooq.pg_catalog.tables.PgConfig.PG_CONFIG.call(
        );
    }
